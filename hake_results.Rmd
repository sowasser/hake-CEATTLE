...
![**Figure 6**: Mean and standard deviation of numbers-at-age from CEATTLE run with the estimate of mean cannibalism and the Stock Synthesis 3.0 run from the 2020 stock assessment.](./plots/CEATTLE/cannibalism/nbyage.png)
...
![**Figure 9**: Ratio of spawning stock biomass (SSB) to total biomass for runs of CEATTLE with varying levels of cannibalism (0.5% to 75%) and the mean cannibalism by weight from the Pacific hake stomach contents datasets.](./plots/CEATTLE/cannibalism/Testing/sensitivity_ratio.png)
