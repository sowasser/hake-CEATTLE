...
![**Figure 10:** Residual (M1) and predation (M2) mortality by age an year for CEATTLE run with varying levels of intraspecific predation (0.5% to 80%).](./plots/CEATTLE/intraspecies%20predation/Testing/test_instrasp_M.png)
