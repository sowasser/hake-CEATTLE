...
![**Figure 9**: Total biomass (mt), recruitment (n), and mean age for the CEATTLE model fitted with the observed proportion of cannibalism by weight and the observed data scaled to varying proportions (0.5% to 75%).](./plots/CEATTLE/cannibalism/Testing/sensitivity_meanage_popdy.png)
