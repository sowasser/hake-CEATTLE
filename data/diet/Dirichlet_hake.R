...
whatplot = 1  #What graphs do you want to produce? Chose 1-4
  ...
  #whatplot = 4 (shows marginal beta, bootstrap histogram and simple average for a particular predator-prey interaction)
    # whatplot4pred = 55		#YFT = pred 55, SF = pred 53
    # whatplot4prey = 17		#deepwater fishes = prey 17
#------------------------------------------------------

x=read.csv("data/diet/hake_for_dirichlet.csv")
...
FigName="MargBeta1.tif"
if(i>10){FigName="MargBeta2.tif"}
if(i>20){FigName="MargBeta3.tif"}
if(i>30){FigName="MargBeta4.tif"}
if(i>40){FigName="MargBeta5.tif"}
if(i>50){FigName="MargBeta6.tif"}
if(i>60){FigName="MargBeta7.tif"}
...
#only show the prey whose MLE is greater than the smallest category
...
if(i%%10==1|i==FirstPredToDo){
FigName="Bootstrap1.tif"
if(i>10){FigName="Bootstrap2.tif"}
if(i>20){FigName="Bootstrap3.tif"}
if(i>30){FigName="Bootstrap4.tif"}
if(i>40){FigName="Bootstrap5.tif"}
if(i>50){FigName="Bootstrap6.tif"}
if(i>60){FigName="Bootstrap7.tif"}
...
FigName = paste(gsub(" ","",predatornames[i]),"_",preyname,".tif",sep="")
tiff(FigName,width=7, height=7, units="in", res=600, compression = "lzw")
...
if(whatplot==3){ 
 if(i == whatplot3pred){
FigName=paste(dat3$Predator[1],"Beta.tif")
