...
![**Figure S.11**: Annual top hake prey by weight in hake stomachs within the CCTD by year of sampling.](./plots/diet/hake_prey_yearly.png)

 &nbsp;  


![**Figure S.12**: Annual occurrence of Pacific hake, by sampling month, in California sea lion (*Zalophus californianus*) scat samples in the CCTD.](./plots/diet/Non-hake/CSL_hake_monthly.png)
