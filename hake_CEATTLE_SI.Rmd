...
![**Figure S.13**: Change in the negative log likelihood and likelihood components for the single-species and cannibalism CEATTLE models with fixed values of M1. Horizontal line is at the threshold for significant improvements in likelihood.](./plots/CEATTLE/cannibalism/Testing/M1/M1_comp_profile.png)

  &nbsp; 

![**Figure S.14**: Spawning stock biomass (Mt) for the single-species and cannibalism CEATTLE model with fixed values of M1. Black line represents SSB derived from the model with M1 fixed at the estimated values for the single-species (0.19) and cannibalism (0.25) models.](./plots/CEATTLE/cannibalism/Testing/M1/M1_profile_SSB.png)
