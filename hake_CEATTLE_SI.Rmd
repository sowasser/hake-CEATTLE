...
![**Figure S.13**: Spawning stock biomass (Mt) for the single-species and cannibalism CEATTLE model with fixed values of M1. Black line represents SSB derived from the model with M1 fixed at the estimated values for the single-species (0.19) and cannibalism (0.25) models.](./plots/CEATTLE/cannibalism/Testing/M1/M1_profile_SSB.png)
 
 &nbsp; 

![**Figure S.14**: Annual occurrence of Pacific hake, by sampling month, in California sea lion (*Zalophus californianus*) scat samples in the CCTD.](./plots/diet/Non-hake/CSL_hake_monthly.png)
