...
nodiet_fixed <- run_CEATTLE(data = hake_intrasp, M1 = 0, prior = FALSE, init = NULL, msm = 0, M_phase = 6)
...
nodiet <- nodiet_est[[1]]
intrasp <-  run_CEATTLE(data = hake_intrasp, M1 = 1, prior = FALSE, init = nodiet$estimated_params, msm = 1, M_phase = 4)
